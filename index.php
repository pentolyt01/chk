...
<body onload="ccgen();  onLoadChks();"style="background-image: url('assets/img/donal.jpg');background-attachment: fixed;background-size: 100% 100%;">
	...
	<div class="container" id="container">
		...
		<div class="row justify-content-md-center">
			<div class="col-md">
				<center>
					<h1 width="500" height="10"  style="margin-top: 30px; color:white;" onclick="modalCCGEN();">ASU</h1>
				</center>
			</div>
		</div>
		<!-- END OF IMAGE HEADER -->
			...
			<div class="col-md-8">
				<form>
					<div class="form-group">
						...
						<textarea class="form-control" style="background: #00000099;color: #FFFFFF;overflow:hidden" id="cards" rows="5" placeholder="xxxxxxxxxxxxxxxx|xx|xxxx|xxx" required></textarea>
					</div>
					<div class="form-group">
						<label for="sk" style="color: #FFFFFF; margin-left: 20px">API</label>
						<div class="input-group mb-3 ">
							<select class="form-control" id="api" style="background: #00000099;color: #FFFFFF;" onchange="showDiv('hidden_div', this)">
					...
					<div class="form-group" id="hidden_div" style="display:none;">
						...
						<div class="input-group mb-3">
							<input type="text" class="form-control" style="background: #00000099;color: #FFFFFF;" id="sk" aria-describedby="sk" placeholder="sk_live_xxxxxxxxxxxxxxxxxx">
							<div class="input-group-append">
								<button class="btn btn-outline-danger" type="button" style="background: #00000099;" onclick="copySK();">
								...
								<button class="btn btn-outline-danger" type="button" style="background: #00000099;" onclick="checkSK();">CHECK SK</button>
							</div>
						</div>
					</div>
					<button style="margin-top: 20px; background: #FF00001D; color: #FFFFFF;" type="button"  class="btn btn-outline-danger btn-block" onclick="checkCards();">CHECK CARDS</button>
				</form>
			</div>
			<div class="col-md-2"></div>
		</div>
		...
		<!-- END OF FORMS -->
		<div class="footer" id="footer"><center><p style="color: #FFFFFF">Drx7</p></center></div>
	</div>
	<!-- START OF CCGEN MODAL -->
	<div class="modal fade" id="ccGEN" role="dialog" aria-hidden="true" >
		<div class="modal-dialog modal-dialog-centered"  style="background: #00000099;">
			<div class="modal-content" style="background: #00000099;">
				<div class="modal-body" style="background: #00000099">
